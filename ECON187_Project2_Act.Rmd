...
We'd also like to create a classifier variable out of guest satisfaction. Interestingly, the median guest satisfaction score for the AirBnB homes in our data aset is 95 out of 100. Empirically, this makes sense since AirBnB customers (just like )
...
# Turn Guest Satisfaction into Indicator Variable

# Use Dplyr To Remove Features We Won't Use 
library(dplyr)
airbnb.cln <- airbnb %>% select(-c("City", "Day","Room.Type",
                                  "Private.Room","Superhost", "Shared.Room",
                                   "Attraction.Index", "Restraunt.Index"))
head(airbnb.cln) # Check to see if all variables we need are in  
```
