...
The accuracy of the cross validation is suggesting uniform performance across all pruning values (0.2417596). Because of this and the previous CV suggestion of 4 beaing the best pruning value, we will not prune the tree.
