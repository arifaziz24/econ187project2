...
```{r}
library(gam)
gam1 <- gam(Deaths~ s(Eggs) + s(Obesity), data = nutrition_cln)

gam2 <- gam(Deaths~ s(Obesity) + poly(Eggs, 4), data = nutrition_cln)
  
gam3 <- gam(Deaths~ poly(Eggs, 3) + Obesity, data = nutrition_cln)
```
