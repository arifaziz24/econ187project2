...
# Random Forest: Shanie


## Regression RF - Shanie
...
# Boosting: Arif (Regression Problem)
```{r}
# For Loop: Five Fold CV to Determine Shrinkage
set.seed(1209745)
library(caret)
...
We'll paste the output (optimized boosting model parameters) from the train function below. An optimal boosting model would create 1500 separate trees (each with an interaction depth of 20), along with a shrinkage parameter of 0.1. Each split would require at least 5 observations, according to our train function. 
